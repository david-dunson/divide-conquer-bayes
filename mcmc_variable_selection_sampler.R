##' Data augmentation for variable selection using GDP prior
##'
##' Sample from the posterior distribution of regression coefficients
##' and noise variance in linear regression using GDP prior. This
##' implements the data augmentation of Argmagan et al. (2013) by
##' fixing $eta = 1$. See Argmagan et al. (2013) for details.
##' @title Gibbs sampler for variable selection
##' @param yvec response.
